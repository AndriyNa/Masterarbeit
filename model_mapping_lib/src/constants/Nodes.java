...
public class Nodes {
	...
	private final static String fetchBool = "var curr = JSON.parse(msg.payload);\n"
	+"var occ = curr.occured;\n"
	+"msg.payload = occ;\n"
	+"return msg; \n";
	private final static String compareString = 
			"var curr = parseInt(JSON.parse(msg.payload));\n"
	        + "msg.situation = {\n"
	        + "  'sensor':'%s', 'value':curr,\n"
	 ...
	 */
	public static String getGREATERTHANNode(String conditionValue, String objectID, String situationTemplateID, String sensorId, String sensorQuality, String quality) {
		return String.format(compareString, sensorId, ">", conditionValue);
	}
	 ...
	 * @return the node as JSON string
	 */
	public static String getLOWERTHANNode(String conditionValue, String objectID, String situationTemplateID, String sensorId, String sensorQuality, String quality) {
		return String.format(compareString, sensorId, "<", conditionValue);
	}
	 ...
	 */
	public static String getANDNode(String numberOfInputs, String objectID, String situationTemplateID, String mapping) {
...
//		String things = mapping.getObjects();
	 ...
	 */
	public static String getNULLNode(String objectID, String situationTemplateID, String mapping) {
//		String things = mapping.getObjects();
		String things = mapping;
		if (things.equals("")) {
			things = "\'" + objectID + "\'";
	...
	public static Object getORNode(String numberOfInputs, String objectID, String situationTemplateID, String mapping) {
...
//        String things = mapping.getObjects();
	 ...
	 */
	public static Object getXORNode(String numberOfInputs, String objectID, String situationTemplateID, String mapping) {
		final String immediateReturnValue = "if (!context.values[i]) {\n            counter++;}\n            returnValue = counter == 1;\n";
//        String things = mapping.getObjects();
		String things = mapping;
        if (things.equals("")) {
	 ...
	 * @return the AND Node in JavaScript
	 */
	public static String getANDNotNode(String numberOfInputs, String objectID, String situationTemplateID, String mapping) {
		final String immediateReturnValue = "if (context.values[i]) {\n	  		counter++;}\n            returnValue = counter < " + numberOfInputs + ";\n";
       // String things = mapping.getObjects();
		String things = mapping;
        if (things.equals("")) {
	 ...
	 * @return the OR Node in JavaScript
	 */
	public static Object getORNotNode(String numberOfInputs, String objectID, String situationTemplateID, String mapping) {
	 ...
	 * @return the XOR Node in JavaScript
	 */
	public static Object getXORNotNode(String numberOfInputs, String objectID, String situationTemplateID, String mapping) {
		final String immediateReturnValue = "if (context.values[i]) {\n            counter++;}\n            returnValue = counter != 1;\n";
//		String things = mapping.getObjects();
		String things = mapping;
		if (things.equals("")) {
	...
	public static String fetchBoolVal (){
		return fetchBool;	
	}
